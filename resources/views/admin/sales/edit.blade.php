        ...
        <div class="row">
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card bg-light-default shadow">
                    ...
                    <div class="card-body">
                    <form method="POST" action="{{ route('admin.sales.update', $sales->first()->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-11 col-md-10 col-sm-11">
                                        <input type="number" class="form-control @error('price') is-invalid @enderror"  name="price" placeholder="{{ old('price',$sales->first()->price) }}" value="{{ $sales->first()->price }}" >
                                        @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <i>{{ $message }}</i>
                                        </span>
