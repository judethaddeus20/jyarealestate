                ...
                <div class="card bg-light-default shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h5 class="text-uppercase text-dark ls-1 mb-1">Create new Sale</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    <form method="POST" action="{{ route('agent.sales.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-11 col-md-10 col-sm-11">
                                        <input type="text" class="form-control @error('agent_name') is-invalid @enderror" id="agent_name" placeholder="Agent Name" name="agent_name">
                                        @error('agent_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-11 col-md-10 col-sm-11">
                                        <input type="text" class="form-control @error('client_name') is-invalid @enderror" id="client_name" placeholder="Client Name" name="client_name">
                                        @error('client_name')
                                            <span class="invalid-feedback" role="alert">
                                                <i>{{ $message }}</i>
                                            </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-11 col-md-10 col-sm-11">
                                        <input type="text" class="form-control @error('developer') is-invalid @enderror" name="developer" id="developer" placeholder="Developers">
                                        @error('developer')
                                        <span class="invalid-feedback" role="alert">
                                            <i>{{ $message }}</i>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-11 col-md-10 col-sm-11">
                                        <input type="text" class="form-control @error('branch') is-invalid @enderror" name="branch" id="branch" placeholder="Branch">
                                        @error('branch')
                                        <span class="invalid-feedback" role="alert">
                                            <i>{{ $message }}</i>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-11 col-md-10 col-sm-11">
                                        <input type="datetime-local" class="form-control @error('date_reserved') is-invalid @enderror" id="date_reserved" placeholder="Date of Reservation" name="date_reserved">
                                        @error('date_reserved')
                                            <span class="invalid-feedback" role="alert">
                                                <i>{{ $message }}</i>
                                            </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-11 col-md-10 col-sm-11">
                                        <input type="text" name="property_name" id="property_name" class="form-control @error('property_name') is-invalid @enderror" placeholder="Property Name"> 
                                        @error('property_name')
                                        <span class="invalid-feedback" role="alert">
                                            <i>{{ $message }}</i>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-11 col-md-10 col-sm-11">
                                        <input type="number" class="form-control @error('price') is-invalid @enderror"  name="price" placeholder="Total Contract Price">
                                        @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <i>{{ $message }}</i>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-md-10 col-sm-11">
                                        <select class="select form-control @error('category') is-invalid @enderror"  name="category" placeholder="Select categories...">
                                    ...
                                    <div class="col-lg-4 col-md-10 col-sm-11">
                                        <input type="number" class="form-control @error('number_of_unit') is-invalid @enderror"  name="number_of_unit" placeholder="Number of Unit">
