                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">{{ count($properties) }}</span>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            ...
                            <!-- <p class="mt-3 mb-0 text-muted text-sm">
                                <span class="text-green mr-2"><i class="fas fa-arrow-up"></i></span>
                                <span class="text-nowrap"></span>
                            </p> -->
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">&#8369;{{ number_format($sales->sum('price'),2) }}</span>
                                </div>
                                <div class="col-auto">
