...
<div class="modal fade" id="loanModal" tabindex="-1" role="dialog" aria-labelledby="loanTitle" aria-hidden="true">
    <div class="modal-dialog  modal-lg  modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header d-flex justify-content-center">
          <h5 class="modal-title" id="loan">Housing Loan Assistance</h5>
        </div>
        <div class="modal-body">
            <form>
                ...
                <div class="input-group p-2">
                    ...
                    <input type="text" class="form-control" id="location" placeholder="Malaybalay, Bukidnon">
                </div>
                <div class="input-group p-2">
                    <div class="input-group-prepend">
